...
const getStoryImage = (story) =>
    story.imageUrl || story.image || story.photoUrl || heroImage
    ...
    const handleDelete = async (id) => {
        ...
        setStories((currentStories) =>
            currentStories.filter((story) => getStoryId(story) !== id),
        )
        } catch (err) {
    ...
    return (
        ...
        {loading ? (
            ...
            {stories.map((story) => {
                ...
                return (
                <article key={id} className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm transition hover:border-teal-200 hover:shadow-md">
